...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 24, 2020 at 08:03 AM
...
(1, 0, 0, 'tensanpham', 0, 0),
(2, 0, 0, 'tensanpham', 0, 0),
(3, 2, 2, 'TOKIBOKI', 12000, 2),
...
(1, 'abc', '12332323', '279 Trần Đại Nghĩa'),
...
(15, 'Trà sữa khoai môn', 40000, 'https://images.foody.vn/res/g97/962055/prof/s280x175/foody-upload-api-foody-mobile-9634301b-f967-430c-b-200504162954.jpg', 'Trà sữa khoai môn có vị béo béo, bùi bùi lạ miệng. Hơn nữa, màu trà sữa là màu tím khoai môn mát mắt, ai nhìn cũng muốn uống ngay. Đã từng là món “best – seller” tại các quán trà sữa Bobapop, Gongcha,… ', 3);
...
(51, '', 'admin@gmail.com', 'admin'),
(53, 'an', 'an@gmail.com', '123');
